...
const Footer = () => {
  return (
    <footer className="bg-gray-900">
      <div className="max-w-6xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-center">
        <div className="text-center sm:text-left mb-4 sm:mb-0">
          <p className="text-gray-300">&copy; 2023 Akiode Timothy</p>
        </div>
        <div className="flex flex-wrap justify-center sm:justify-start items-center">
          <p className="text-gray-300 mr-4 mb-2 sm:mb-0">
            Phone: +(234) 814-9792-957
          </p>
          <p className="text-gray-300 mr-4 mb-2 sm:mb-0">
          ...
          <a
            ...
            className="text-gray-300 hover:text-white ml-4 mb-2 sm:mb-0"
          >
